<div align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,60:1a1030,100:6e40c9&height=170&section=header&text=Philippe%20Godfroy&fontSize=44&fontColor=ffffff&fontAlignY=58&animation=fadeIn&desc=IT%20Developer%20%C2%B7%20Product%20Engineer%20%C2%B7%20Business%20Analyst%20%C2%B7%20Indie%20Founder&descSize=14&descAlignY=78&descColor=bc8cff" width="100%"/>
</div>
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=14&pause=1000&color=bc8cff&background=00000000&center=true&vCenter=true&width=620&lines=Self-taught+IT+developer+%26+entrepreneur+from+Belgium.;Swift+%C2%B7+Python+%C2%B7+React+%C2%B7+SQL+%C2%B7+and+much+more.;I+don't+just+know+the+theory.+I've+shipped+the+product.;Open+to+the+right+opportunity.)](https://git.io/typing-svg)
...
✅  Product mindset      — I think like a founder, not just a task-executor
✅  Execution-first      — I ship working software, not slide decks about shipping
✅  Cross-functional     — I handle dev, UX, monetisation, BA, and ops simultaneously
✅  Technical + business — I understand both layers and bridge them fluently
✅  Trilingual           — Dutch (native) · French (fluent) · English (professional)
✅  Honest               — Clear about what I know, clear about what I'm still learning
```
...
![Supabase](https://img.shields.io/badge/Supabase_Cloud-3ECF8E?style=flat-square&logo=supabase&logoColor=black)
...
![Azure](https://img.shields.io/badge/Azure_(basics)-0078D4?style=flat-square&logo=microsoft-azure&logoColor=white)
...
### 💰 App Platforms & Monetisation
![App Store](https://img.shields.io/badge/App_Store_Connect-0D96F6?style=flat-square&logo=app-store&logoColor=white)
...
### 📋 Business Analysis
`BRD / FRD` `BPMN` `User Stories` `Acceptance Criteria` `MoSCoW`
`Gap Analysis` `Root Cause Analysis` `Stakeholder Mapping` `Process Modeling`
`Business Case Writing` `Risk Assessment` `UAT Planning`
...
| **FYESTO** | iOS event discovery app | SwiftUI · Supabase · Realtime · MapKit | 🔨 Building |
| **GymLabb** | Fitness coaching platform | Python · Supabase · Everfit · Stripe | 🧪 Beta |
...
2019 → 2020:
  ...
  what:     Short-term rental management (B2B). Client relations,
            SLA management, process coordination, escalation handling.

≈2018:
  company:  Louis Vuitton
  role:     Stock Controller
  what:     Inventory management, compliance, reporting, and
            reconciliation within a structured luxury retail environment.

2015 → 2018:
  company:  PhilPhone VoF
  role:     Founder & Lead Technician
  what:     Founded and operated a mobile device repair business.
            Customer management, service delivery, technical repair,
            business operations end-to-end.

continuous:
  what:     Self-directed learning in IT development, business analysis,
            product management, and entrepreneurship since ~2010.
...
- AI integration in native macOS/iOS apps (CoreML, on-device LLMs)
- Oracle APEX and enterprise application platforms
- EDI systems and supply chain data flows
- Process mining and data-driven process analysis
- Automation tooling for business and development workflows

---

## 📫 Open To

- Full-time IT roles — development, product, BA, or hybrid
- Freelance / contract — macOS, iOS, automation, backend, or BA consulting
- Technical co-founder or product collaboration
- Consulting on App Store strategy, Swift architecture, or SaaS tooling
